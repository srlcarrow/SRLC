                                ...
                                <div id="tab1_<?php echo $ref; ?>" class="col s12 mt-30">
                                    ...
                                    <div class="row mb-0">
                                        ...
                                        <div class="col s8">
                                            ...
                                            <div class="row ">
                                                <div class="col s12">
                                                    <button type="button" class="right btn waves-effect waves-light red lighten-1">Edit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="responsive-table bordered striped">
                                                ...
                                                <tr id="12">
                                                    ...
                                                    <td class="adm-tbl-action_2">
                                                        <button type="button" class="btnActive right btn waves-effect waves-light green lighten-1">Active</button>
                                                    </td>
                                                </tr>
                                                <tr id="13">
                                                    <td style="width: 10%">00012</td>
