        ...
        <div class="card-panel">
            <div class="search-input-wrp grey lighten-3">
                <div class="search-input">
                    ...
                    <input id="searchText" name="searchAddText" class="input-search" type="text" placeholder="Search" onkeyup="loadPendingAdsToPubData(1)">
                </div>
                <div class="search-action">

                    <button type="button" class="border-r-0 btn waves-effect waves-light btn-search deep-orange" onclick="loadPendingAdsToPubData(1)">Search</button>
                </div>
                <div class="search-action">
            ...
            <div class="row hide-block more-panel">
                ...
                <div class="col s12 right-align">
                    ...
                    <button type="button" class=" btn waves-effect waves-light deep-orange" onclick="loadPendingAdsToPubData(1)">Search</button>
                </div>
            </div>
        </div>
    </div>
