                ...
                <div class="row mb-0 expand-card-head">
                    <div class="col s11">
                        <div class="row mb-0">                         
                            ...
                            <div class="col s3">
                                <button id="<?php echo $value->ad_id; ?>" onclick="viewAndPub(this.id)">View And Publish</button>    
                            </div>                   
                        </div>
                    </div>
                    <div class="col s3">
                        <button id="<?php echo $value->ad_id; ?>" onclick="Publish(this.id)">Publish</button>    
                    </div>                   
                </div>
            </div>
